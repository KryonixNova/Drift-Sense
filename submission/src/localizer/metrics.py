...
def summarize(pred_x, pred_y, gt_x, gt_y, scores,
             tolerances=(1.0, 3.0, 5.0), primary_tolerance=None) -> dict:
    ...
    primary = primary_tolerance if primary_tolerance is not None else max(tolerances)
